  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.screenBg }} edges={['top']}>
      <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: screenPadding, paddingTop: 12, paddingBottom: 16, gap: 8 }}>
        ...
        <Text style={{ fontFamily: fontFamily.anuphan.bold, fontSize: 17, color: colors.ink }}>ประวัติการชำระ</Text>
      </View>
      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: screenPadding, gap: 16 }}>
        <View style={{ width: 80, height: 80, borderRadius: 40, backgroundColor: colors.hairline, alignItems: 'center', justifyContent: 'center' }}>
          <MaterialIcons name="calendar-today" size={40} color={colors.textTertiary} />
        </View>
        <Text style={{ fontFamily: fontFamily.anuphan.bold, fontSize: 20, color: colors.ink2, textAlign: 'center' }}>ยังไม่มีประวัติการชำระ</Text>
        <Text style={{ fontFamily: fontFamily.anuphan.regular, fontSize: 14, color: colors.textSecondary, textAlign: 'center', lineHeight: 22 }}>
          การชำระเบี้ยประกันของคุณจะปรากฏที่นี่ พร้อมดาวน์โหลดได้
        </Text>
      </View>
      ...
      <View style={{ paddingHorizontal: screenPadding, paddingBottom: insets.bottom + 16 }}>
        <TouchableOpacity onPress={() => navigation.navigate('PaySelect')} activeOpacity={0.82}
          ...
          <Text style={{ color: colors.white, fontFamily: fontFamily.anuphan.bold, fontSize: 16 }}>จ่ายเบี้ยฯ</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
